...
pcmy_shopify_simple['Lineitem discount'] = (pcmy_shopify_simple['Lineitem compare at price'] - pcmy_shopify_simple['Lineitem price'])/pcmy_shopify_simple['Lineitem compare at price']
